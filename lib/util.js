...
exports.loadimage = function(src, onload, options) {
  ...
  // TODO: consider seperating to 2 functions - 1 with cache and one without
  //       in order to not have to look in options.cache (as I should be doing here but am not)
  var cached = image_cache[src];
