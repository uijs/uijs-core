...
// syntax: positioning.fill.width|height([box]) default is `parent`
exports.fill = {
  width: _bind_target(function(t) { return t && t.width; }),
  height: _bind_target(function(t) { return t && t.height; }),
};

// syntax: positioning.center.width|height([box])
exports.center = {
  width: _bind_target(function(t) { return t && (t.width / 2 - this.width / 2); }),
  height: _bind_target(function(t) { return t && (t.height / 2 - this.height / 2); }),
};

function _bind_target(fn) {
  return function(t) {
